      ...
      <header className="header animate-fade-in">
        <div className="header-container">
          ...
          <nav className="nav-desktop">
            ...
            <Link to="/admin/dashboard" className={`nav-link ${isActive('/admin/dashboard')}`}>Admin</Link>
            <Link to="/chef/dashboard" className={`nav-link ${isActive('/chef/dashboard')}`}>Chef</Link>
            <Link to="/rider/dashboard" className={`nav-link ${isActive('/rider/dashboard')}`}>Rider</Link>
          </nav>
        ...
        {isMobileMenuOpen && (
          <nav className="nav-mobile">
            ...
            <Link to="/chef/dashboard" className={`nav-link ${isActive('/chef/dashboard')}`} onClick={toggleMobileMenu}>Chef Portal</Link>
            <Link to="/rider/dashboard" className={`nav-link ${isActive('/rider/dashboard')}`} onClick={toggleMobileMenu}>Rider Portal</Link>
